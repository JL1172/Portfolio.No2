...
export default function About(props) {
  const { render, changeRender, currentPage } = useContext(GlobalContext);
  useEffect(() => {
  ...
  return (
    <StyledAbout id="about" className={render === "about" ? "show" : "hidden"}>
      ...
      <div id="outerContainer" className="hidden-text">
        ...
        <div className={currentPage === 1 ? "active" : "not-active"} id="container1">I am a <span className="span">dedicated</span> student currently enrolled at Bloom Institute of Technology, specializing in <span className="span ">Full-stack web development</span>. Additionally, I am pursuing a Bachelor's degree in <span className="span ">Accounting</span> with a focus on public accounting at GCU.</div>
